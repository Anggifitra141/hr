    ...
    <div class="main-wrapper main-wrapper-1">
      ...
      <div class="main-sidebar sidebar-style-2">
        <aside id="sidebar-wrapper">
          <div class="sidebar-brand">
            <a href="<?php echo base_url(); ?>">HR - Attendance</a>
          </div>
          ...
          <ul class="sidebar-menu">
            ...
            <li>
              <a href="<?php echo site_url('departement'); ?>" class="nav-link"><i class="fas fa-layer-group"></i><span>Departement</span></a>
            </li>
            <li>
      ...
      <footer class="main-footer">
        <div class="footer-left">
          Copyright &copy; 2021 HR - Attendance || By <a href="https://seiberms.com/">PT. Seiber Mitra Solusi </a> <div class="bullet"></div> All Right Reserved
        </div>
